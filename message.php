...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/message.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:08:52 GMT -->
<head>
     <meta charset="utf-8">
...
<body>
  ...
  $('#chat__form').on('submit', function(e) {
    ...
    $('#text-message').val('');
    var date = new Date().toJSON().slice(0,10).replace(/-/g,'../index.html');
...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/message.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:08:57 GMT -->
</html>