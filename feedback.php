...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/feedback.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:24 GMT -->
<head>
     <meta charset="utf-8">
				...
				<ul class="metismenu" id="menu">
                     <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="food-order.php
							">የምግብ ማዘዣ</a></li>
							<li><a href="favorite-menu.php
							">ተወዳጅ ምናሌ</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							">ትዕዛዞች</a></li>
							<li><a href="customer-reviews.php
							">ግምገማዎች</a></li>
							<li><a href="restro-setting.php
							">ቅንብር</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="deliver-main.php
							">ዳሽቦርድ</a></li>
							<li><a href="deliver-order.php
							">ትዕዛዞች</a></li>
							...
							<div class="card-body pb-0">
								<div class="row">
									<div class="col-xl-9 col-lg-12">
										<h3 class="font-w700">Statistic</h3>
										<div id="chartBar">
										</div>
									</div>
									<div class="col-xl-3 col-lg-12">
										<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
											<div>
												<select class="form-control default-select  me-3 ms-0  border" style="display: none;">
										...
										<div class="feedback-right mb-4">
											<div class="d-flex align-items-center mb-4">
												<div class="d-flex align-items-center">
													<svg  class="me-2" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
														<rect x="1.5" y="1.5" width="9" height="9" rx="4.5" fill="white" stroke="#FC8019" stroke-width="3"/>
													</svg>
													<span>Positive</span>
												</div>
												<div class="d-flex align-items-center ms-4">
													<svg  class="me-2" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
													<rect x="1.5" y="1.5" width="9" height="9" rx="4.5" fill="white" stroke="#EB5757" stroke-width="3"/>
													</svg>
													<span>Bad</span>
												</div>
											</div>
											<h4 class="font-w400 text-nowrap">Positive Feedback</h4>
											<h3 class="font-w700">3.456</h3>
											...
											<div class="d-flex align-items-center flex-wrap">
												...
												<h4 class="text-primary mb-0 mx-2">+15%</h4>
												<span>From last month</span>
											</div>
										</div>
										<div class="feedback-right mb-3 mb-md-0">
											<h4 class="font-w400">Bad Feedback</h4>
											<h3 class="font-w700">3.456</h3>
										
											<div class="d-flex align-items-center flex-wrap mb-xl-0 mb-3">
												<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
												<g clip-path="url(#clip0_1001_28)">
												...
												<h4 class="text-danger mb-0 mx-2">+15%</h4>
												<span>From last month</span>
											</div>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<h4 class="cate-title">Recent Feedback</h4>
									<div class="d-flex align-items-center">
											...
											<div class="card">
												<div class="card-body">
													<div class="feedback-bx">
														...
														<div class="restro-review d-flex align-items-center mt-4">
															<img src="assets/images/resturent-review/pic-1.jpg" alt="">
															<div>
											...
											<div class="card">
												<div class="card-body">
													<div class="feedback-bx">
														...
														<div class="restro-review d-flex align-items-center mt-4">
															<img src="assets/images/resturent-review/restro-feedback/pic-1.jpg" alt="">
															<div>
																<h4 class="font-w500">Jack Jock</h4>
																<span>User since 2020</span>
															</div>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-body">
													<div class="feedback-bx">
														...
														<div class="restro-review d-flex align-items-center mt-4">
															<img src="assets/images/resturent-review/restro-feedback/pic-2.jpg" alt="">
															<div>
																<h4 class="font-w500">Danny Ahmad</h4>
																<span>User since 2020</span>
															</div>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-body">
													<div class="feedback-bx">
														...
														<div class="restro-review d-flex align-items-center mt-4">
															<img src="assets/images/resturent-review/restro-feedback/pic-3.jpg" alt="">
															<div>
																<h4 class="font-w500">Clara Hope</h4>
																<span>User since 2020</span>
															</div>
														</div>
													</div>
...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/feedback.php
 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:28 GMT -->
</html>