			...
			<div class="container">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<div class="d-flex align-items-center justify-content-between mb-2 gap">
									<h4 class=" mb-0 cate-title">ምድብ</h4>
									<a href="favorite-menu.php" class="text-primary">ሁሉንም ይመልከቱ <i class="fa-solid fa-angle-right ms-2"></i></a>
								</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javascript:void(0);"><h6 class="mb-0 font-w500">ዳቦ ቤት</h6></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javascript:void(0);"><h6 class="mb-0 font-w500">እርጥብ</h6></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javscript:void(0);"><h6 class="mb-0 font-w500">መጠጥ</h6></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javascript:void(0);"><h6 class="mb-0 font-w500">ዶሮ</h6></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javascript:void(0);"><h6 class="mb-0 font-w500">ፒዛ</h6></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="cate-bx text-center">
											<div class="card">
												<div class="card-body">
													...
													<a href="javscript:void(0);"><h6 class="mb-0 font-w500">እርጥብ</h6></a>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-xl-12">
								<div class="d-flex align-items-center justify-content-between mb-2">
									<h4 class=" mb-0 cate-title">ተወዳጅ ምግቦች</h4>
									<a href="favorite-menu.php" class="text-primary">ሁሉንም ይመልከቱ <i class="fa-solid fa-angle-right ms-2"></i></a>
								</div>
										...
										<div class="swiper-slide">
											<div class="card dishe-bx">
												<div class="card-header border-0 pb-0 pt-0 pe-3">
													<span class="badge badge-lg badge-danger side-badge">15% ቅናሽ</span>
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>እርትብ</h4></a>
										...
										<div class="swiper-slide">
											<div class="card dishe-bx exclusive">
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>በየአይነት</h4></a>
															<h3 class="font-w700 mb-0 text-primary">$5.59</h3>
														</div>
														<div class="plus c-pointer">
															<div class="sub-bx">
										...
										<div class="swiper-slide">
											<div class="card dishe-bx">
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>ሽሮ</h4></a>
															<h3 class="font-w700 mb-0 text-primary">$5.59</h3>
														</div>
														<div class="plus c-pointer">
															<div class="sub-bx">
										...
										<div class="swiper-slide">
											<div class="card dishe-bx">
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>ፓስታ</h4></a>
															<h3 class="font-w700 mb-0 text-primary">$5.59</h3>
														</div>
														<div class="plus c-pointer">
															<div class="sub-bx">
										...
										<div class="swiper-slide">
											<div class="card dishe-bx pt-0">
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>ሩዝ</h4></a>
															<h3 class="font-w700 mb-0 text-primary">$5.59</h3>
														</div>
														<div class="plus c-pointer">
															<div class="sub-bx">
										...
										<div class="swiper-slide">
											<div class="card dishe-bx">
												...
												<div class="card-footer border-0 px-3">
													...
													<div class="common d-flex align-items-end justify-content-between" >
														<div>
															<a href="javascript:void(0);"><h4>እንቁላል</h4></a>
															<h3 class="font-w700 mb-0 text-primary">$5.59</h3>
														</div>
														<div class="plus c-pointer">
															<div class="sub-bx">
							...
							<div class="col-xl-12">
								<div class="d-flex align-items-center justify-content-between mb-2">
									<h4 class=" mb-0 cate-title">የቅርብ ጊዜ ትዕዛዝ</h4>
									<a href="favorite-menu.php" class="text-primary">ሁሉንም ይመልከቱ <i class="fa-solid fa-angle-right ms-2"></i></a>
								</div>
								...
								<div class="card dlab-bg dlab-position">
									<div class="card-header border-0 pb-0">
										...
										<div class="order-check d-flex align-items-center my-3">
											...
											<div class="dlab-info">
												<div class="d-flex align-items-center justify-content-between">
													<h4 class="dlab-title"><a href="javascript:void(0);">በየአይነት</a></h4>
										...
										<div class="order-check d-flex align-items-center my-3">
											...
											<div class="dlab-info">
												<div class="d-flex align-items-center justify-content-between">
													<h4 class="dlab-title"><a href="javascript:void(0);">እርትብ</a></h4>
													<h4 class="text-primary ms-2">+$5.59</h4>
												</div>
												<div class="d-flex align-items-center justify-content-between">
													<span>x1</span>
										...
										<div class="order-check d-flex align-items-center my-3">
											...
											<div class="dlab-info">
												<div class="d-flex align-items-center justify-content-between">
													<h4 class="dlab-title"><a href="javascript:void(0);">ሽሮ</a></h4>
													<h4 class="text-primary ms-2">+$5.59</h4>
												</div>
												<div class="d-flex align-items-center justify-content-between">
													<span>x1</span>
									...
									<div class="card-footer  pt-0 border-0">
										...
										<div class="d-flex align-items-center justify-content-between mb-3">
											<h4 class="font-w500">ድምር</h4>
											<h3 class="font-w500 text-primary">$202.00</h3>
										</div>
										<a href="checkout-page.php" class="btn btn-primary btn-block">ጨርሰህ ውጣ</a>
									</div>
								</div>
							</div>
							<div class="col-xl-12">
									...
									<div class="card-body pe-0 p-4 pb-3">
										<div class="dlab-media d-flex justify-content-between">
											<div class="dlab-content">
												<h4 class="cate-title">20% የዋጋ ቅናሽ ቫውቸር ያግኙ  </h4>
					...
					<div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">የአካባቢ ዝርዝሮችን ያክሉ</h5>
							...
							<div class="modal-body add-loaction">
								<div class="row">
									<div class="col-xl-12">
										<form>
										  <div class="mb-3">
											<label class="form-label">የአካባቢ ስም</label>
									...
									<div class="col-xl-6">
										<form>
										  <div class="mb-3">
											<label class="form-label">ለትዕዛዝ ይገኛል</label>
						  ...
						  <div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ይውጡ</button>
							<button type="button" class="btn btn-primary">ለውጦችን አስቀምጥ</button>
						  </div>
						</div>
					</div>
				</div>
				<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel2">የመንገድ ማስታወሻዎችን ያስተዳድሩ</h5>
							<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						  </div>
							<div class="modal-body add-note">
								<div class="row align-items-center">
									<div class="col-xl-12">
										<form class="mb-3">
											<label class="form-label">የዝማኔ አይነት</label>
									...
									<div class="col-xl-12">
										<form class=" mb-3"> 
											<label class="form-label">የተቀባይ ቦታ</label>
									...
									<div class="col-xl-12">
										 <div class="mb-3">
											<label class="from-label">አድራሻ</label>
