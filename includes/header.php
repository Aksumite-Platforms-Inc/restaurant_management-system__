        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.php" class="brand-logo">
				...
				<img src="assets/images/logo.png" width="197px" alt="">
            </a>
																	...
																	<div class="card mb-0">
																		<div class="card-body pb-2 pt-3">
																			<div class="text-center pop-cousin">
																				...
																				<a href= "javascript:void(0);"><h6>ዕርጥብ</h6></a>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="swiper-slide">
																	<div class="card mb-0">
																		<div class="card-body pb-2 pt-3">
																			<div class="text-center pop-cousin">
																				<img src="assets/images/popular-img/pic-1.jpg" alt="">
																				<a href= "javascript:void(0);"><h6>በየአይነት</h6></a>
																			</div>
																		</div>
																	</div>
																</div>
									...
									<div class="dropdown header-profile2 ">
										<a class="nav-link " href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
											<div class="header-info2 d-flex align-items-center">
												...
												<div class="d-flex align-items-center sidebar-info">
													<div>
														<h6 class="font-w500 mb-0 ms-2">ሽጋ</h6>
													</div>	
										...
										<div class="dropdown-menu dropdown-menu-end">
											...
											<a href="edit-profile.php" class="dropdown-item ai-icon">
												...
												<span class="ms-2">መገለጫ አስተካክል</span>
											</a>
										...
										<a href="setting.php" class="dropdown-item ai-icon ">
											...
											<a href="page-login.php" class="dropdown-item ai-icon ms-1">
