...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/orders.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:09 GMT -->
<head>
     <meta charset="utf-8">
							...
							<div class="card-body">
								<nav class="order-tab">
								  <div class=" nav nav-tabs" id="nav-tab" role="tablist">
									<button class="nav-link active" id="nav-order-tab" data-bs-toggle="tab" data-bs-target="#nav-order" type="button" role="tab" aria-controls="nav-order" aria-selected="true">Order in</button>
									<button class="nav-link" id="nav-prepared-tab" data-bs-toggle="tab" data-bs-target="#nav-prepared" type="button" role="tab" aria-controls="nav-prepared" aria-selected="false">Prepared</button>
								  ...
								  <div class="tab-pane fade show active" id="nav-order" role="tabpanel" aria-labelledby="nav-order-tab">
									<div class="orderin-bx d-flex align-items-center justify-content-between">
										...
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="icon-bx"><i class="fa-solid fa-angle-right"></i></a>
								...
								<div class="card-body">
									<div class="d-flex align-items-center justify-content-between border-bottom flex-wrap">
										...
										<div class="orders-img d-flex mb-4">
											<img src="assets/images/chat-img/orders-img/pic-1.jpg" alt="">
											<div>
									...
									<div class="order-menu style-1 mt-3">
										...
										<div class="d-flex align-items-center pb-2">
											<img class="me-3" src="assets/images/popular-img/pic-1.jpg" alt="">
											<div>
												<h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Pepperoni Pizza</a></h4>
												<p class="mb-0">x1</p>
											</div>
...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/orders.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:10 GMT -->