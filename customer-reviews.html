...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/customer-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:10 GMT -->
<head>
     <meta charset="utf-8">
...
<body>
							...
							<div class="card-body pb-0 pb-sm-4">
								<div class="row">
									<div class="col-xl-5 col-sm-5">
										<h4 class=" cate-title font-w700">አዎንታዊ ግምገማ</h4>
					...
					<div class="col-xl-6 col-sm-12">
						<div class="card">
							<div class="card-body pb-0 pb-sm-4">
								<div class="row">
									<div class="col-xl-5 col-sm-5">
										<h3 class="cate-title font-w700">አሉታዊ ግምገማ
										</h3>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
								<div>
									<h3 class=" cate-title font-w700 mb-4">የቅርብ ጊዜ ግምገማዎች</h3>
									<div class="d-flex align-items-center justifiy-content-between mb-4">
										<div class="input-group search-area2 style-1 w-50">
											...
											<input type="text" class="form-control p-0" placeholder="ምን መመገብ ትፈልጋለሀ...">
										</div>
								...
								<div class="tab-content" id="pills-tabContent">
										...
										<div class="row">
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-2.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-3.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3  col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-4.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-5.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-6.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3  col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-7.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
											...
											<div class="col-xl-3 col-xxl-4 col-sm-6">
												<div class="card">
													<div class="card-body">
														<div class="restro-review d-flex align-items-center border-bottom mb-4  pb-4">
															<img src="assets/images/resturent-review/pic-8.jpg" alt="">
															<div>
																<h4 class="font-w500">Ruby Roben</h4>
																<span>User since 2020</span>
															</div>
									...
									<div class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap pagination-bx">
										<div class="mb-sm-0 mb-3 pagination-title">
											<p class="mb-0"><span>ከ100 ውሂብ </span>ከ1-5<span>በማሳየት ላይ</span> </p>
										</div>
										<nav>
   ...
   <p>የቅጂ መብት © የተነደፈ  by <a href="https://" target="_blank">shega tech</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	...
	<!-- Dashboard 1 -->
	<script src="assets/js/dashboard/dashboard-3.js"></script>
...
<!-- Mirrored from www.fooddesk.dexignlab.com/xhtml/customer-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 10:09:19 GMT -->
</html>